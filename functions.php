...
if ( function_exists( 'register_sidebar' ) ) {
	...
	register_sidebar( array(
		...
		register_sidebar( array(
		'name' => __( 'City Sidebar', 'mighty' ),
		'id' => 'sidebar-page',
		'description' => __( 'Widgets placed here will display in the sidebar on city pages.', 'mighty' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget' => '</section>',
		'before_title' => '<h4 class="widget-title">',
		'after_title' => '</h4>',
...
if ( !function_exists( 'mighty_gallery' ) ) {
	function mighty_galleryx( $post_id ) {
...
/* ----------------------------------------------------------------
   14. CONTACT FORM
-----------------------------------------------------------------*/
if ( !function_exists( 'mighty_contact_form' ) ) {
	
	function mighty_contact_formx() {
...
/* Options Framework */
define( 'OPTIONS_FRAMEWORK_DIRECTORY', get_template_directory_uri() . '/../revelant/includes/framework/' );
require_once dirname( __FILE__ ) . '/../relevant/includes/framework/options-framework.php';
